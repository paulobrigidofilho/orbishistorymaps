...
<!--
  ...
  Purpose: Complete database schema, relationships, queries, and best practices
  Last Updated: December 29, 2025
-->

# 💾 Database Schema & Architecture

Comprehensive documentation of the PostgreSQL database schema for the Orbis application, including table definitions, relationships, queries, and optimization guidelines.
...
3. **Indexing** - Optimize common queries
...
graph LR
    Users["📊 users<br/>id, email, password_hash<br/>firstName, lastName<br/>avatar_url, role, status"]:::gold
    ...
    Products["🛍️ products<br/>id, name<br/>description, price<br/>inventory, category"]:::black
    Carts["🛒 carts<br/>id, user_id<br/>session_id, created_at"]:::gold
    CartItems["📦 cart_items<br/>id, cart_id<br/>product_id, quantity"]:::black
    Orders["📋 orders<br/>id, user_id<br/>status, total_amount"]:::gold
